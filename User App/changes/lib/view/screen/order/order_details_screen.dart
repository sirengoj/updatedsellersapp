                              ...
                              children: [
                                ...
                                Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                                  ...
                                  Text('${getTranslated('SHIPPING_TO', context)} : ', style: titilliumRegular),
                                      Expanded(child: Text(' ${orderModel.shippingAddressData != null ? orderModel.shippingAddressData.address :''}', maxLines: 3, overflow: TextOverflow.ellipsis, style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL))),
                                ]),
                                orderModel.billingAddressData != null?
                                Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                                  children: [
                                    Text('${getTranslated('billing_address', context)} :',  style: titilliumRegular),
                                    Expanded(child: Text(' ${orderModel.billingAddressData != null ? orderModel.billingAddressData.address : ''}', maxLines: 3, overflow: TextOverflow.ellipsis, style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL))),
                                  ],
                                ):SizedBox(),
                                ...
                                Row(children: [
                                  Expanded(
                                      child: Text(getTranslated('chosen_shipping', context), style: titilliumRegular)),
