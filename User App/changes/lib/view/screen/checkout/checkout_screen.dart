                ...
                child: Column(children: [
                  ...
                  Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                    children: [
                      ...
                      Expanded(child: Text(
                        Provider.of<OrderProvider>(context,listen: false).addressIndex == null ? getTranslated('add_your_address', context)
                            : Provider.of<ProfileProvider>(context, listen: false).addressList[Provider.of<OrderProvider>(context, listen: false).addressIndex].address,
                      ...
                      InkWell(
                        onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => SavedAddressListScreen())),
                        child: Container(
                            decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10)),
                                color: ColorResources.getPrimary(context)),
                            child: Padding(
                              padding: const EdgeInsets.all(2.7),
                              child: Icon(Icons.edit, size: 9, color: Theme.of(context).cardColor),
                            )),
                      ),
                  ...
                  Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment:CrossAxisAlignment.start,
                    children: [
                      ...
                      SizedBox(width: Dimensions.PADDING_SIZE_DEFAULT),
                      InkWell(
                        onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => SavedBillingAddressListScreen())),
                        child: Container(
                            decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10)),
                                color: ColorResources.getPrimary(context)),
                            child: Padding(
