                    ...
                    itemBuilder: (context, index, _) {
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          _clickBannerRedirect(context, bannerProvider.mainBannerList[index].resourceType=='product'?bannerProvider.mainBannerList[index].product.id : bannerProvider.mainBannerList[index].resourceId, bannerProvider.mainBannerList[index].product.slug, bannerProvider.mainBannerList[index].resourceType);
                        },
                        child: Container(
