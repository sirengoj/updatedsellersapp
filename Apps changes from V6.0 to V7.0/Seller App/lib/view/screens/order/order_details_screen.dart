...
class OrderDetailsScreen extends StatelessWidget {
  ...
  void _loadData(BuildContext context, String type) async {
    ...
    Provider.of<OrderProvider>(context, listen: false).initOrderStatusList(context, shippingType);
    Provider.of<DeliveryManProvider>(context, listen: false).getDeliveryManList(orderModel, context);
  }

  @override
  Widget build(BuildContext context) {
    _loadData(context,shippingType);
    return Scaffold(
          ...
          builder: (context, order, child) {
            ...
            if(orderType == 'POS'){
              if(extraDiscountType == 'percent'){
                eeDiscount = _itemsPrice * (extraDiscount/100);
              }else{
            ...
            return order.orderDetails != null ? order.orderDetails.length > 0 ? ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column( crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(padding: const EdgeInsets.only(bottom: 20.0),
                      child: orderType == 'POS'? SizedBox(): Consumer<DeliveryManProvider>(builder: (context, deliveryMan, child) {
                        return Row(
                          children: [
                            Expanded(
                              child: Container(
                ...
                order.isLoading
                  ...
                  child: orderType =='POS'? SizedBox():Consumer<OrderProvider>(builder: (context, order, child) {
                    return Row(
                      children: [
                        Expanded(
                          child: Container(
